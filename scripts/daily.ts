...
async function enrichResearchJobs(articles: ArticleInput[]): Promise<void> {
  await enrichMergedSubgroup(articles, "tech", "research-jobs");
}
...
async function main() {
  ...
  await enrichResearchJobs(articles);
